...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-5 gap-6 pt-5 px-3 sm:px-0'>
        {doctors.slice(0, 10).map((item, index) => (
          <div onClick={()=>{navigate(`/appointment/${item._id}`);scrollTo(0,0)}} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer w-full max-w-[220px] mx-auto transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg'
            key={index}
          >
